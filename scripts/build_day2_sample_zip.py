#!/usr/bin/env python3
"""Build the committed Day 2 sample-file archive deterministically."""
...
SOURCE_DIRECTORY = REPOSITORY_ROOT / "day-2-m365-copilot" / "files"
OUTPUT_DIRECTORY = REPOSITORY_ROOT / "day-2-m365-copilot" / "downloads"
OUTPUT_FILE = OUTPUT_DIRECTORY / "day-2-sample-files.zip"
ARCHIVE_ROOT = Path("day-2-sample-files")
