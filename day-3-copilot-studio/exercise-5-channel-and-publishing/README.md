...
1. ทดสอบใน **Test your agent** ก่อน แล้วทำซ้ำกับ Agent ฉบับที่ publish ใน **Microsoft 365 Copilot** ด้วย prompt อย่างน้อย 2 แบบ
   - แนบ XLSX ฉบับปัจจุบันแล้วส่ง `ช่วยสรุปรายงานนี้ให้ผู้บริหาร พร้อมชี้ 3 ประเด็นที่ควรติดตาม` ตรวจตัวเลขตาม [แบบฝึกหัดที่ 3](../exercise-3-excel-analysis/README.md) และคง Code Interpreter เป็น Off
...
[← กลับไปสารบัญ Day 3](../README.md) | [แบบฝึกหัดถัดไป (ทางเลือก): เติม AI Agent Canvas →](../exercise-6-agent-canvas-template/README.md)
