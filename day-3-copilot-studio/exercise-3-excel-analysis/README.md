...
- ทำ [เพิ่ม Knowledge](../exercise-2-knowledge/README.md) แล้ว ใช้ Agent `Financial Report Assistant` ตัวเดิม
...
[← กลับไปสารบัญ Day 3](../README.md) | [แบบฝึกหัดถัดไป: เพิ่ม Agent Flow สำหรับส่งอีเมล →](../exercise-4-agent-flow-as-a-tools/README.md)
