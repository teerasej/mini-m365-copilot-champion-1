...
### Practice 1: วาด current state "AS-IS" workflow สำหรับ pain point กลุ่มที่เลือก
...
ึ
ึ7. หากมีขั้นตอนใด ใช้งานโปรแกรมไหนเป็นพิเศษ เช่น word, excel, powerpoint, outlook, teams, sharepoint ให้เขียนชื่อโปรแกรมลงบน post-it ต่างหาก และแปะลงบนขั้นตอนนั้นๆ
8. ทำจนได้ workflow map ที่ชัดเจนว่าแต่ละขั้นตอนทำอะไร ใครทำ และมี input/output อะไรบ้าง
9.  เสร็จแล้วถ่ายรูปเก็บไว้ได้
