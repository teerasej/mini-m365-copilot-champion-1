...
7. หากมีขั้นตอนใด ใช้งานโปรแกรมไหนเป็นพิเศษ เช่น word, excel, powerpoint, outlook, teams, sharepoint ให้เขียนชื่อโปรแกรมลงบน post-it ต่างหาก และแปะลงบนขั้นตอนนั้นๆ
