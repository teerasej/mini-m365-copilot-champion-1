...
ทีมบริหารต้องการทราบ 3 ประเด็นของสถานการณ์ที่ควรเร่งแก้ไข แต่คำถามเดียวกันอาจให้ผลต่างกันตาม source ที่ Copilot ได้รับ
...
4. บันทึกว่าคำตอบอ้างอิงข้อมูลใด มีตัวเลขหรือ citation หรือไม่ อย่าเพิ่งตัดสินว่าคำตอบถูกต้อง
...
1. ในแบบฝึกหัดนี้ พลจะให้เราใช้ prompt จาก Practice 2 นะครับ ดังนั้นสามารถ copy prompt เดิมมาใช้ได้เลย
2. เพิ่มไฟล์ที่ไม่เกี่ยวข้อง 1 ไฟล์จากชุด workshop เช่น `business-idea.docx` แล้วส่ง prompt เดิมอีกครั้ง
